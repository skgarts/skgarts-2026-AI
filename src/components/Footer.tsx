        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="mailto:srikanth@skgarts.com" className="font-paragraph text-sm text-primary hover:text-primary/80 transition-colors">srikanth@skgarts.com</a>
              </div>
              <div className="flex items-center gap-3">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              ...
              <a
                href="https://www.facebook.com/skgarts"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-primary/10 hover:bg-primary/20 flex items-center justify-center transition-colors text-primary"
                aria-label="Facebook"
